...
const variables: Record<string, string> = {
  PLC_Bit: "M2000,100",
  PLC_Word_CT: "D2000,100",
  PLC_Word_Model: "D3000,100",
};

const bitMap: Record<string, { source: string; offset: number }> = {
  M122A_Status: { source: "PLC_Bit", offset: 0 },
  M121A_Status: { source: "PLC_Bit", offset: 10 },
};
...
> = {
  M122A_CT: { source: "PLC_Word_CT", offset: 0, isFloat: true }, //CT
  M122A_Model: {
  ...
  M121A_CT: { source: "PLC_Word_CT", offset: 10, isFloat: true }, //CT
  M121A_Model: {
    source: "PLC_Word_Model",
    offset: 10,
    isPackedString: true,
